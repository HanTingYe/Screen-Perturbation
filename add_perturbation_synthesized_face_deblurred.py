                    ...
                    if location_flag == 1:
                        ...
                        if (color_flag == 1):
                            ...
                            if find_color_flag == 1:
                                ...
                                blueopt_allpixel_mask_index = blueopt_allpixel_mask_index[
                                    blueopt_allpixel_mask_index != 0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_cap_dir', type=str, default='cap_allcolorbar_face_test',
                        help='save perturbed images')  # cap_allcolorbar_p10_v1
    parser.add_argument('--save_dec_dir', type=str, default='dec_allcolorbar_face_test',
