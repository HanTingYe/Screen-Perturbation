        ...
        for batch_id, batch_img in enumerate(train_ds):
            ...
            while (location_flag):
                with tf.GradientTape() as g:
                    ...
                    interfer_pixel[33] = 4  ##green nouse
                    ...
                    # image_pil.save(img_path, quality=95)
                    ...
                    if (color_flag == 1):
                        ...
                        if opt.search_criteria == 1:
                            judge_crteria = predict[predict_cla].numpy() - target_category_prob
                        elif opt.search_criteria == 2:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--search_criteria', type=int, default=2, help='max screen_brightness')
