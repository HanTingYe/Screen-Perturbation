...
def optimize_pattern_with_data(opt):
    ...
    display_interference_pre = crop_image(cv2.resize(np.array(u1_RGB_real_mask_temp), None, fx=3, fy=3, interpolation=cv2.INTER_AREA), img_height, img_width) #INTER_LINEAR INTER_AREA
