...
class InceptionResnetV1(nn.Module):
    ...
    def __init__(self, pretrained=None, classify=False, num_classes=None, dropout_prob=0.6, device=None):
        ...
        if pretrained == 'vggface2':
            ...
            tmp_classes = 8631 ## train based on vggface2
...
def load_weights(mdl, name):
    ...
    if name == 'vggface2':
        ...
        cached_file = './inception_resnet_v1_mtcnn_FaceScrub_cap_allpixel_1_0_vggface2SGD_v4.pth'
    elif name == 'facescrub_dec':
        cached_file = './inception_resnet_v1_mtcnn_FaceScrub_dec_allpixel_1_0_vggface2SGD_v4.pth'
    else:
    ...
    state_dict = torch.load(cached_file, mdl.device)
