        ...
        for batch_id, batch_img in enumerate(train_ds):
            ...
            while (location_flag):
                with tf.GradientTape() as g:
                    ...
                    interfer_pixel[36:38] = 0.5  ##green

                    interfer_pixel[48:50] = 0.5  ##green

                    interfer_pixel[54:56] = 0.5  ##green
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained', type=str, default='resnet50', help='pretrained network model mobilenet_v3_large')
